...
import static com.libra.core.exception.CoreExceptionEnum.INIT_TABLE_EMPTY_PARAMS;

/**
 * @author Libra
 * @date 2018/11/28
 * @description 数据库初始化，可初始化表，校验字段，校验表名是否存在等
 */
@Slf4j
@Getter
@Setter
public abstract class DbInitializer {
    ...
    private void initTable() {
        ...
        if (EmptyUtil.isOneEmpty(tableName, tableInitSql)) {
