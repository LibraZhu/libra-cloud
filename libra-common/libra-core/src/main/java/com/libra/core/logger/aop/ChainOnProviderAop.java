package com.libra.core.logger.aop;

import com.baomidou.mybatisplus.toolkit.IdWorker;
import com.libra.core.context.RequestNoContext;
import com.libra.core.logger.context.ParentSpanIdHolder;
import com.libra.core.logger.context.SpanIdContext;
import com.libra.core.logger.context.SpanIdHolder;
import com.libra.core.logger.context.TraceIdHolder;
import com.libra.core.logger.enums.RpcPhaseEnum;
import com.libra.core.logger.util.TraceUtil;
...
import static com.libra.core.constants.AopSortConstants.CHAIN_ON_PROVIDER_SORT;

/**
 * @author Libra
 * @date 2018/11/28
 * @description 基于调用链的服务治理系统的设计（服务提供者的aop处理）
 */
@Aspect
