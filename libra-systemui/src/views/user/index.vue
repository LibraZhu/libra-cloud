    ...
    >
      ...
      <el-table-column :label="操作" align="center" width="230" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button type="primary" size="mini" @click="handleRoleCreate(scope.row)">角色</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="角色" :visible.sync="dialogRoleVisible">
      <el-form>
        <el-form-item label="">
          ...
          <el-button v-waves type="primary" @click="handleRoleAdd">添加
          </el-button>
        </el-form-item>
      </el-form>
      <el-table
      ...
      >
        ...
        <el-table-column :label="操作" align="center" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button type="danger" size="mini" @click="handleRoleDelete(scope.row)">删除
            </el-button>
          </template>
        </el-table-column>
      </el-table>
