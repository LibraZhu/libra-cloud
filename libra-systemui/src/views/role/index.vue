<template>
  <div class="app-container">
    <div class="filter-container">
      <el-button v-waves class="filter-item" type="primary" icon="el-icon-edit" @click="handleCreate">添加
      </el-button>
    </div>
    <el-table
    ...
    >
      ...
      <el-table-column :label="操作" align="center" width="230" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button type="primary" size="mini" @click="handleResourceCreate(scope.row)">资源
          </el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="dialogStatus==='create'?createData():updateData()">确定
        </el-button>
      </div>
    </el-dialog>

    <el-dialog :title="资源" :visible.sync="dialogResourceVisible">
      <el-checkbox v-model="checkAll" @change="handleCheckAllChange">全选</el-checkbox>
      <div style="margin: 15px 0;" />
      <el-checkbox-group v-model="tempResource.resourceCodeList" @change="handleCheckedResource">
        <el-checkbox v-for="item in resourceList" :key="item.url" :label="item.code">{{
          createResourceTitle(item.name,item.url) }}
        </el-checkbox>
      </el-checkbox-group>
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogResourceVisible = false">取消</el-button>
        <el-button type="primary" @click="modifyRoleResourceList()">确定
        </el-button>
      </div>
    </el-dialog>
  </div>
